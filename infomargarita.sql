...
CREATE TABLE IF NOT EXISTS `tbl_ciudad` (
  ...
  `Des_Ciudad` varchar(52) NOT NULL,
...
INSERT INTO `tbl_ciudad` (`Cod_Ciudad`, `Cod_Estado`, `Des_Ciudad`) VALUES
(1, 1, 'Maroa'),
(2, 1, 'Puerto Ayacucho'),
...
(523, 27, 'california sur'),
(524, 27, 'california sur 2'),
(525, 16, 'colom'),
(526, 1, 'ssdfds'),
(527, 1, 'dsfdsfdsf'),
(528, 16, 'nueva esparta de mis amores'),
(529, 1, 'ayuda'),
(530, 7, 'peru y boliva'),
(531, 27, 'peru y boliva'),
(532, 38, 'CucUTA');
...
CREATE TABLE IF NOT EXISTS `tbl_estado` (
  `Cod_Estado` int NOT NULL,
  `Des_Estado` varchar(52) NOT NULL,
  PRIMARY KEY (`Cod_Estado`),
  UNIQUE KEY `Des_Estado` (`Des_Estado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `tbl_estado` (`Cod_Estado`, `Des_Estado`) VALUES
(1, 'Amazonas'),
(37, 'Amazonas del Caribe'),
(2, 'Anzoátegui'),
(3, 'Apure'),
(4, 'Aragua'),
(5, 'Barinas'),
...
(11, 'Guárico'),
(26, 'Guatamuri'),
(28, 'La Calufornia Norte'),
(12, 'Lara'),
(29, 'Los Chorros de Milla'),
(13, 'Mérida'),
(14, 'Miranda'),
(15, 'Monagas'),
(38, 'Norte de Santander'),
(16, 'Nueva Esparta'),
(17, 'Portuguesa'),
(31, 'Prueba '),
(30, 'sadsadsad'),
(32, 'SADSADSADSADSAD'),
(36, 'saturnina rodirguez victoris'),
(35, 'sdasdasdas'),
(33, 'SDSADSA'),
(18, 'Sucre'),
(19, 'Táchira'),
...
INSERT INTO `tbl_municipio` (`Cod_Municipio`, `Cod_Estado`, `Des_Municipio`) VALUES
(1, 1, 'Alto Orinoco'),
(2, 1, 'Atabapo'),
(3, 1, 'Atures'),
(4, 1, 'Autana'),
...
(465, 1, 'sdadsadsa'),
(466, 2, 'sssssss'),
(467, 1, 'Valle del Campo'),
(468, 27, 'californua sur'),
(469, 16, 'la california norte'),
(470, 16, 'nueva esparta municipio segundo'),
(471, 2, 'Cojedes de mi vida y de mis amores'),
(472, 8, 'Cojedes de mi vida');
...
CREATE TABLE IF NOT EXISTS `tbl_parroquia` (
  ...
  `Cod_Municipio` int NOT NULL,
  `Des_Parroquia` varchar(100) NOT NULL,
...
INSERT INTO `tbl_parroquia` (`Cod_Parroquia`, `Cod_Municipio`, `Des_Parroquia`) VALUES
(1, 1, 'Alto Orinoco'),
...
ALTER TABLE `tbl_ciudad`
  ADD CONSTRAINT `tbl_ciudad_ibfk_1` FOREIGN KEY (`Cod_Estado`) REFERENCES `tbl_estado` (`Cod_Estado`) ON DELETE RESTRICT;

--
-- Filtros para la tabla `tbl_municipio`
--
ALTER TABLE `tbl_municipio`
  ADD CONSTRAINT `tbl_municipio_ibfk_1` FOREIGN KEY (`Cod_Estado`) REFERENCES `tbl_estado` (`Cod_Estado`) ON DELETE RESTRICT;

--
-- Filtros para la tabla `tbl_parroquia`
--
ALTER TABLE `tbl_parroquia`
  ADD CONSTRAINT `tbl_parroquia_ibfk_1` FOREIGN KEY (`Cod_Municipio`) REFERENCES `tbl_municipio` (`Cod_Municipio`) ON DELETE RESTRICT;

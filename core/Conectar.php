...
// Aqui encontraran las funciones de conexion, restore y desconexion a la base de datos
// las cuales son llamadas desde los archivos models del programa
...
class Conectar{
    ...
    public static function conexionRestore() {
        ...
        self::$user    =$database_cfg["user"];
        self::$pass    =$database_cfg["pass"];
        self::$database=$database_cfg["databaserepaldo"];
        self::$charset =$database_cfg["charset"];
